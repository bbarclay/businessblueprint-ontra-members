	...
	<div class="extra-info">
		...
		<div class="panel">
		    	...
		    	<div class="location"><span class="label">Address </span><span class="text"><?php echo $this->address; ?> <?php echo $this->address2; ?>, <?php echo $this->city; ?> <?php echo $this->state; ?>, <?php echo $this->get_country( $this->country ); ?>  <?php echo $this->zipcode; ?> </span></div>
		</div>
